...
namespace RcRenuevaFico\Simulacion\Client\Api;
...
use RcRenuevaFico\Simulacion\Client\HeaderSelector;
use RcRenuevaFico\Simulacion\Client\ObjectSerializer;

class ReporteDeCreditoRenuevaConFicoScoreApi
{
    ...
    {
        $returnType = '\RcRenuevaFico\Simulacion\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenuevaFico\Simulacion\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenuevaFico\Simulacion\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
