...
class DomicilioPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\RcRenuevaFico\Simulacion\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\RcRenuevaFico\Simulacion\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\RcRenuevaFico\Simulacion\Client\Model\CatalogoTipoAsentamiento'
    ];
